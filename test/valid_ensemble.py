...
mat_path0 = r'E:\master\AWAN-master\AWAN_Clean\test\valid_results1'
mat_path1 = r'E:\master\AWAN-master\AWAN_Clean\test\valid_results2'
# mat_path2 = './valid_results3/'
# mat_path3 = './valid_results4/'

save_path = r'E:\master\AWAN-master\AWAN_Clean\test\final_valid_results'
...
for i in range(len(mat_path1_name)):
    ...
    res = 0.25 * res0 + 0.25 * res1
    #res = 0.25 * res0 + 0.25 * res1 + 0.25 * res2 + 0.25 * res3
    print(mat_path0_name[i].split('/')[-1], mat_path1_name[i].split('/')[-1])
